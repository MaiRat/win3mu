...
[Run]
Filename: "{tmp}\dotNetFx40_Client_setup.exe"; Parameters: "/q /norestart"; Check: not IsRequiredDotNetDetected; StatusMsg: Microsoft Framework 4.0 is be�ng installed. Please wait, might take a while...
