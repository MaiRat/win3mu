...
namespace Win3muCore.MessageSemantics
{
    class MessageMap
    {
        ...
        void Load()
        {
            ...
            Add(WndClassKind.Button, Win32.BM_GETSTATE, Win16.BM_GETSTATE, new unused());
            ...
            // Static
            Add(WndClassKind.Static, Win32.STM_SETICON, Win16.STM_SETICON, new hgdiobj_unused());
            Add(WndClassKind.Static, Win32.STM_GETICON, Win16.STM_GETICON, new unused());

            // Edit
            Add(WndClassKind.Edit, Win32.EM_GETSEL, Win16.EM_GETSEL, new unused());
            Add(WndClassKind.Edit, Win32.EM_SETSEL, Win16.EM_SETSEL, new cracked_lparam16());
            Add(WndClassKind.Edit, Win32.EM_LINESCROLL, Win16.EM_LINESCROLL, new cracked_lparam16());
            Add(WndClassKind.Edit, Win32.EM_GETMODIFY, Win16.EM_GETMODIFY, new unused());
            Add(WndClassKind.Edit, Win32.EM_SETMODIFY, Win16.EM_SETMODIFY, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_GETLINECOUNT, Win16.EM_GETLINECOUNT, new unused());
            Add(WndClassKind.Edit, Win32.EM_LINEINDEX, Win16.EM_LINEINDEX, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_LINELENGTH, Win16.EM_LINELENGTH, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_REPLACESEL, Win16.EM_REPLACESEL, new unused_string());
            Add(WndClassKind.Edit, Win32.EM_SETLIMITTEXT, Win16.EM_LIMITTEXT, new copy());
            Add(WndClassKind.Edit, Win32.EM_CANUNDO, Win16.EM_CANUNDO, new unused());
            Add(WndClassKind.Edit, Win32.EM_UNDO, Win16.EM_UNDO, new unused());
            Add(WndClassKind.Edit, Win32.EM_FMTLINES, Win16.EM_FMTLINES, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_LINEFROMCHAR, Win16.EM_LINEFROMCHAR, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_SETPASSWORDCHAR, Win16.EM_SETPASSWORDCHAR, new copy_unused());
            Add(WndClassKind.Edit, Win32.EM_EMPTYUNDOBUFFER, Win16.EM_EMPTYUNDOBUFFER, new unused());
            ...
            Add(WndClassKind.Listbox, Win32.LB_DELETESTRING, Win16.LB_DELETESTRING, new copy_unused());
            Add(WndClassKind.Listbox, Win32.LB_SETSEL, Win16.LB_SETSEL, new copy());
            Add(WndClassKind.Listbox, Win32.LB_SETCURSEL, Win16.LB_SETCURSEL, new copy_unused());
            Add(WndClassKind.Listbox, Win32.LB_GETSEL, Win16.LB_GETSEL, new copy_unused());
            ...
            Add(WndClassKind.Listbox, Win32.LB_GETTEXTLEN, Win16.LB_GETTEXTLEN, new copy_unused());
            Add(WndClassKind.Listbox, Win32.LB_GETCOUNT, Win16.LB_GETCOUNT, new unused());
            Add(WndClassKind.Listbox, Win32.LB_SELECTSTRING, Win16.LB_SELECTSTRING, new copy_string());
            Add(WndClassKind.Listbox, Win32.LB_FINDSTRING, Win16.LB_FINDSTRING, new copy_string());
            Add(WndClassKind.Listbox, Win32.LB_GETSELCOUNT, Win16.LB_GETSELCOUNT, new unused());
            Add(WndClassKind.Listbox, Win32.LB_GETHORIZONTALEXTENT, Win16.LB_GETHORIZONTALEXTENT, new unused());
            Add(WndClassKind.Listbox, Win32.LB_SETHORIZONTALEXTENT, Win16.LB_SETHORIZONTALEXTENT, new copy_unused());
            Add(WndClassKind.Listbox, Win32.LB_SETCOLUMNWIDTH, Win16.LB_SETCOLUMNWIDTH, new copy_unused());
            ...
            Add(WndClassKind.Listbox, Win32.LB_GETITEMDATA, Win16.LB_GETITEMDATA, new copy_unused());
            Add(WndClassKind.Listbox, Win32.LB_SETITEMDATA, Win16.LB_SETITEMDATA, new copy());
            Add(WndClassKind.Listbox, Win32.LB_SELITEMRANGE, Win16.LB_SELITEMRANGE, new copy());
            Add(WndClassKind.Listbox, Win32.LB_GETCARETINDEX, Win16.LB_GETCARETINDEX, new unused());
            Add(WndClassKind.Listbox, Win32.LB_SETCARETINDEX, Win16.LB_SETCARETINDEX, new copy());
            ...
            Add(WndClassKind.Combobox, Win32.CB_LIMITTEXT, Win16.CB_LIMITTEXT, new copy_unused());
            Add(WndClassKind.Combobox, Win32.CB_SETEDITSEL, Win16.CB_SETEDITSEL, new copy());
            Add(WndClassKind.Combobox, Win32.CB_ADDSTRING, Win16.CB_ADDSTRING, new ClassComboBox.CB_ADDSTRING());
            Add(WndClassKind.Combobox, Win32.CB_DELETESTRING, Win16.CB_DELETESTRING, new copy_unused());
            Add(WndClassKind.Combobox, Win32.CB_DIR, Win16.CB_DIR, new copy_string());
            ...
            Add(WndClassKind.Combobox, Win32.CB_GETLBTEXTLEN, Win16.CB_GETLBTEXTLEN, new copy_unused());
            ...
            Add(WndClassKind.Combobox, Win32.CB_SELECTSTRING, Win16.CB_SELECTSTRING, new copy_string());
            Add(WndClassKind.Combobox, Win32.CB_SETCURSEL, Win16.CB_SETCURSEL, new copy_unused());
            Add(WndClassKind.Combobox, Win32.CB_SHOWDROPDOWN, Win16.CB_SHOWDROPDOWN, new copy_unused());
            ...
            Add(WndClassKind.Combobox, Win32.CB_SETITEMHEIGHT, Win16.CB_SETITEMHEIGHT, new copy());
            Add(WndClassKind.Combobox, Win32.CB_GETITEMHEIGHT, Win16.CB_GETITEMHEIGHT, new copy_unused());
            Add(WndClassKind.Combobox, Win32.CB_SETEXTENDEDUI, Win16.CB_SETEXTENDEDUI, new copy_unused());
